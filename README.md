...
- [x] Extensive compatibility and user-friendly interface: compatible with Pore-C data; supports .pairs file generated by chromap; provides a built-in one-command pipeline; able to produce highly customizable vector graphics for contact maps
